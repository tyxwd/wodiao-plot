<template>
  <div class="echarts-demo">
    ...
    <div id="earth_chart" ref="earth_chart"></div>
  </div>
</template>
...
import {TitleComponent, TooltipComponent, GridComponent,
  TimelineComponent, LegendComponent,} from 'echarts/components';
import {PieChart} from 'echarts/charts'
echarts.use([TitleComponent, TooltipComponent, GridComponent, TimelineComponent, LegendComponent]);
echarts.use([PieChart])
export default {
  name: "Earth",
  mounted() {
    var dom = document.getElementById("earth_chart");
